...
public class MenuUtama extends JFrame {
    ...
    private void initComponents() {
        ...
        lblSubjudul = new JLabel("MAHASISWA", SwingConstants.CENTER);
        ...
        // Footer
        lblFooter = new JLabel("© 2024 Sistem Informasi Mahasiswa", SwingConstants.CENTER);
        lblFooter.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        lblFooter.setForeground(new Color(255, 255, 255, 180));
        lblFooter.setBounds(50, 640, 500, 20);
